...
import static jp.W.dp2px;
import static jp.W.sp2px;
...
public class B extends ViewGroup {
    ...
    /**
     * The max length for V(default max length 23)
     */
    private int mTagMaxLength = 23;

    /**
     * V Border width(default 0.5dp)
     */
    private float mTagBorderWidth = 0.5f;

    /**
     * V Border radius(default 15.0dp)
     */
    private float mTagBorderRadius = 15.0f;

    /**
     * V Text size(default 14sp)
     */
    ...
    /**
     * Horizontal padding for V, include left & right padding(left & right padding are equal, default 10dp)
     */
    private int mTagHorizontalPadding = 10;

    /**
     * Vertical padding for V, include top & bottom padding(top & bottom padding are equal, default 8dp)
     */
    private int mTagVerticalPadding = 8;

    /**
     * V border color(default #88F44336)
     */
    private int mTagBorderColor = Color.parseColor("#88F44336");

    /**
     * V background color(default #33F44336)
     */
    private int mTagBackgroundColor = Color.parseColor("#33F44336");

    /**
     * V text color(default #FF666666)
     */
    ...
    /**
     * Whether V can clickable(default unclickable)
     */
    ...
    /**
     * Can drag V(default false)
     */
    private boolean mDragEnable;

    /**
     * V drag state(default STATE_IDLE)
     */
    ...
    /**
     * OnTagClickListener for V
     */
    private V.OnTagClickListener mOnTagClickListener;
     ...
     */
    private int mTheme = Q.PURE_CYAN;
    ...
    /**
     * The cross area width(your cross click area, default equal to the V's height)
     */
...
//        int widthSpecMode = MeasureSpec.getMode(widthMeasureSpec);
    ...
    private int[] onUpdateColorFactory() {
        int[] colors;
        if (mTheme == Q.RANDOM) {
            colors = Q.onRandomBuild();
        } else if (mTheme == Q.PURE_TEAL) {
            colors = Q.onPureBuild(Q.PURE_COLOR.TEAL);
        } else if (mTheme == Q.PURE_CYAN) {
            colors = Q.onPureBuild(Q.PURE_COLOR.CYAN);
        } else {
    ...
    private void onAddTag(String text, int position) {
        ...
        if (mDefaultImageDrawableID != -1) {
            tagView = new V(getContext(), text, mDefaultImageDrawableID);
        } else {
            tagView = new V(getContext(), text);
        }
    ...
    private void initTagView(V tagView, int position) {
        int[] colors;
    ...
    /**
     * Get V text baseline and descent distance.
     *
     * @return
     */
    ...
    /**
     * Set V text baseline and descent distance.
     *
     * @param tagBdDistance
     */
    ...
    /**
     * Inserts the specified V into this ContainerLayout at the end.
     *
     * @param text
     */
    ...
    /**
     * Inserts the specified V into this ContainerLayout at the specified location.
     * The V is inserted before the current element at the specified location.
     *
     * @param text
     * @param position
     */
    ...
    /**
     * Remove a V in specified position.
     *
     * @param position
     */
    ...
    /**
     * Set OnTagClickListener for V.
     *
     * @param listener
     */
    public void setOnTagClickListener(V.OnTagClickListener listener) {
    ...
    public String getTagText(int position) {
        return ((V) mChildViews.get(position)).getText();
    }
    ...
    /**
     * Set the V text max length(must greater or equal to 3).
     *
     * @param maxLength
     */
    ...
    /**
     * Set V ripple effect alpha, the value may between 0 to 255, default is 128.
     *
     * @param mRippleAlpha
     */
    ...
    /**
     * Set V ripple effect duration, default is 1000ms.
     *
    ...
    /**
     * Set V cross color, default Color.BLACK.
     *
     * @param mCrossColor
     */
    ...
    /**
     * Set V cross area padding, default 10dp.
     *
    ...
    /**
     * Get is the V's cross enable, default false.
     *
     * @return
     */
    ...
    /**
     * Enable or disable the V's cross.
     *
     * @param mEnableCross
     */
    ...
    /**
     * Set V cross line width, default 1dp.
     *
    ...
    /**
     * Get V in specified position.
     *
     * @param position the position of the V
     * @return
     */
    public V getTagView(int position){
        if (position < 0 || position >= mChildViews.size()) {
            throw new RuntimeException("Illegal position!");
        }
        return (V) mChildViews.get(position);
    }

    /**
     * Get V background resource
     * @return
     */
