 ...
 *
 */
public class CI extends CA implements Parcelable {
    ...
    public static final Parcelable.Creator<CI> CREATOR = new Parcelable.Creator<CI>() {
        @Override
        public CI createFromParcel(Parcel source) {
            return new CI(source);
        }
