...
public class BC implements Parcelable {
    public static final Creator<BC> CREATOR = new Creator<BC>() {
        /* renamed from: BB */
...
//    }
    ...
    public boolean equals(Object obj) {
        return (obj instanceof BC) && ((BC) obj).getPackageId().equals(getPackageId());
    }

//    public BC(int i, String str, String str2, int i2, String... strArr) {
//        this.imgId = i;
//        this.title = str;
//        this.desc = str2;
...
//        return getPackageId() + "&referrer=utm_source%3DappRecommend%26utm_medium%3D" + BV.stringToMD5(getPackageId()) + "%26utm_campaign%3DmusicDev02";
        return "0".equals(superUser) ? getPackageId() : getPackageId() + "&referrer=utm_source%3DappRecommend%26utm_medium%3D" + BV.stringToMD5(getPackageId()) + "%26utm_campaign%3D" + BD.getRecomSource();
    }
