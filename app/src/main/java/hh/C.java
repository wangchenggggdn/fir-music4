    ...
    public void startPointSpread(final ImageView starView, final Runnable finishRunnable) {
        ...
        scaleYAnimator.addListener(new AnimatorListenerAdapter() {
            public void onAnimationStart(Animator animation) {
                ...
                starView.setImageDrawable(C.this.getResources().getDrawable(R.drawable.bl_ic_rating_star));
            }
        });
        new ValueAnimator();
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                C.this.pointRadial = dp2px(C.this.getContext(), (float)value);
                C.this.invalidate();
            }
        });
