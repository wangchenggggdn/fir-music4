...
public class N extends AppCompatActivity {
    ...
    private C[] starFrameLayouts = new C[5];
    ...
    private void initView() {
        ...
        C starFrameLayout1 = (C) this.findViewById(R.id.star1);
        ...
        C starFrameLayout2 = (C) this.findViewById(R.id.star2);
        ...
        C starFrameLayout3 = (C) this.findViewById(R.id.star3);
        ...
        C starFrameLayout4 = (C) this.findViewById(R.id.star4);
        ...
        C starFrameLayout5 = (C) this.findViewById(R.id.star5);
        ...
        starIV1.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            public void onGlobalLayout() {
                ...
                starIV1.postDelayed(new Runnable() {
                    public void run() {
                        N.this.handleMoveAnimation(handleIV, starIV5, new Runnable() {
                            public void run() {
    ...
    private void startAnimationSpread() {
        this.starFrameLayouts[this.currentIndex].startPointSpread(this.startIVS[this.currentIndex], new Runnable() {
            public void run() {
                N.this.currentIndex++;
                if (N.this.currentIndex < 5) {
                    N.this.starFrameLayouts[N.this.currentIndex].startPointSpread(N.this.startIVS[N.this.currentIndex], this);
                } else {
    ...
    private void stopAnimationSpread() {
        C[] var1 = this.starFrameLayouts;
        int var2 = var1.length;

        int var3;
        for (var3 = 0; var3 < var2; ++var3) {
            C starPointContainer = var1[var3];
