package hifi.music.tube.downloader.referrer;
...
public abstract class BaseReferrer extends CA implements Parcelable {
    ...
    public boolean isInvalid() {
        try {
            ...
            String phoneCountry = BV.getPhoneCountry(H.getInstance());
