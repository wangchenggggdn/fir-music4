...
import static jf.CI.CHANNEL_LOCAL;
...
public class Utils {
    ...
    public static List<CI> scanDir(String dir) {
        List<CI> musicList = new ArrayList<>();
        ...
        if (file.exists() && file.isDirectory()) {
            ...
            for (File musicFile : sort(arrayList.toArray(new File[arrayList.size()]))) {
                ...
                //封面
                File cover = new File(BL.getInstance().getCoverPath(), title + ".jpg");
                if (cover.exists()) {
    ...
    public static String getlocaleCountry(){
        return H.mInstance.getResources().getConfiguration().locale.getCountry();
    }

    public static String getLocaleLanguage(){
        return H.mInstance.getResources().getConfiguration().locale.getLanguage();
    }
...
//    }
    ...
    public static String readAsset(String name) {
        ...
        try {
            AssetManager assets = H.getInstance().getAssets();
            is = assets.open(name);
