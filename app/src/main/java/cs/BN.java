    ...
    private Uri getUri(int type) {
        ...
        try {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                cursor = H.getInstance().getContentResolver().query(uri,
                        new String[]{
                                BaseColumns._ID,
...
//                        new String[]{mBean.title, BL.folder}, null);
            } else {
                cursor = H.getInstance().getContentResolver().query(uri,
                        new String[]{
                                BaseColumns._ID,
            ...
            if (cursor != null && cursor.moveToFirst()) {
                ...
                H.getInstance().getContentResolver().update(uri, values, MediaStore.MediaColumns.DATA + "=?", new String[]{f.getAbsolutePath()});
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                    ...
                    return H.getInstance().getContentResolver().insert(uri, values);
                }
